...
<body>
    ...
    <main>
        <div class="texto">
            <h1><img src="https://escuelasdecodigo.cdmx.gob.mx/wp-content/themes/escuelasdecodigo/dist/assets/hero-vector.svg" alt="">APRENDE A PROGRAMAR <br>EN LAS <span>ESCUELAS</span><br><span>DE CODIGO</span><br>DE LA CDMX</h1>
        </div>
    </main>
    <footer>
        <h2>Quién se puede inscribir?</h2>
        <p class="parrafo" > <b>Cualquier persona que quiera aprender a programar  y cuente con 4-8 horas disponibles a la semana</b> </p>
        <p class="parrafo" >*menores de edad deberan entrar a las instalaciones acompañados de un adulto</p>
    </footer>
</body>
</html>
